...
var role_enum_1 = __importDefault(require("../model/role.enum"));
// compare passwords
// generate jwt
...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, newUser, createdUser, token, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, user_service_1["default"].findByUsername(req.body.username)];
                case 1:
                    user = _a.sent();
                    if (user) {
                ...
                case 2:
                    createdUser = _a.sent();
                    token = jwt_service_1["default"].sign(createdUser);
                    res.json({
